...
impl<E: Engine> Sha256Gadget<E> {
    pub fn iv() -> [E::Fr; 8] {
        [
            u64_to_ff(0x6a09e667),
            u64_to_ff(0xbb67ae85),
            u64_to_ff(0x3c6ef372),
            u64_to_ff(0xa54ff53a),
            u64_to_ff(0x510e527f),
            u64_to_ff(0x9b05688c),
            u64_to_ff(0x1f83d9ab),
            u64_to_ff(0x5be0cd19),
        ]
    }
    ...
    pub fn new<CS: ConstraintSystem<E>>(
        ...
        let maj_and_sheduler_num_of_chunks =
            maj_sheduler_base_num_of_chunks.unwrap_or(MAJ_AND_SHEDULER_DEFAULT_NUM_OF_CHUNKS);
        ...
        let sha256_base7_rot6_table = get_or_create_table(cs, name1, || {
        ...
        let sha256_base7_rot3_extr10_table = get_or_create_table(cs, name2, || {
            LookupTableApplication::new(
                name2,
                SparseRotateTable::new(
                    SHA256_GADGET_CHUNK_SIZE,
                    3,
                    SHA256_GADGET_CHUNK_SIZE - 1,
                    SHA256_CHOOSE_BASE,
                    name2,
                ),
                columns3.clone(),
        ...
        let sha256_base4_rot2_table = get_or_create_table(cs, name3, || {
            LookupTableApplication::new(
                name3,
                SparseRotateTable::new(
                    SHA256_GADGET_CHUNK_SIZE,
        ...
        let sha256_base4_rot2_width10_table = get_or_create_table(cs, name4, || {
            LookupTableApplication::new(
                name4,
                SparseRotateTable::new(
                    SHA256_GADGET_CHUNK_SIZE - 1,
        ...
        let sha256_ch_normalization_table = get_or_create_table(cs, name5, || {
            LookupTableApplication::new(
                name5,
        ...
        let sha256_maj_sheduler_normalization_table = get_or_create_table(cs, name6, || {
            LookupTableApplication::new(
                name6,
                MultiBaseNormalizationTable::new(
        ...
        let sha256_base4_rot7_table = get_or_create_table(cs, name7, || {
            LookupTableApplication::new(
                name7,
                SparseRotateTable::new(
                    SHA256_GADGET_CHUNK_SIZE,
        ...
        let sha256_sheduler_helper_table = get_or_create_table(cs, name8, || {
            LookupTableApplication::new(
                name8,
        ...
        let round_constants = [
            u64_to_ff(0x428a2f98),
            u64_to_ff(0x71374491),
            u64_to_ff(0xb5c0fbcf),
            u64_to_ff(0xe9b5dba5),
            u64_to_ff(0x3956c25b),
            u64_to_ff(0x59f111f1),
            u64_to_ff(0x923f82a4),
            u64_to_ff(0xab1c5ed5),
            u64_to_ff(0xd807aa98),
            u64_to_ff(0x12835b01),
            u64_to_ff(0x243185be),
            u64_to_ff(0x550c7dc3),
            u64_to_ff(0x72be5d74),
            u64_to_ff(0x80deb1fe),
            u64_to_ff(0x9bdc06a7),
            u64_to_ff(0xc19bf174),
            u64_to_ff(0xe49b69c1),
            u64_to_ff(0xefbe4786),
            u64_to_ff(0x0fc19dc6),
            u64_to_ff(0x240ca1cc),
            u64_to_ff(0x2de92c6f),
            u64_to_ff(0x4a7484aa),
            u64_to_ff(0x5cb0a9dc),
            u64_to_ff(0x76f988da),
            u64_to_ff(0x983e5152),
            u64_to_ff(0xa831c66d),
            u64_to_ff(0xb00327c8),
            u64_to_ff(0xbf597fc7),
            u64_to_ff(0xc6e00bf3),
            u64_to_ff(0xd5a79147),
            u64_to_ff(0x06ca6351),
            u64_to_ff(0x14292967),
            u64_to_ff(0x27b70a85),
            u64_to_ff(0x2e1b2138),
            u64_to_ff(0x4d2c6dfc),
            u64_to_ff(0x53380d13),
            u64_to_ff(0x650a7354),
            u64_to_ff(0x766a0abb),
            u64_to_ff(0x81c2c92e),
            u64_to_ff(0x92722c85),
            u64_to_ff(0xa2bfe8a1),
            u64_to_ff(0xa81a664b),
            u64_to_ff(0xc24b8b70),
            u64_to_ff(0xc76c51a3),
            u64_to_ff(0xd192e819),
            u64_to_ff(0xd6990624),
            u64_to_ff(0xf40e3585),
            u64_to_ff(0x106aa070),
            u64_to_ff(0x19a4c116),
            u64_to_ff(0x1e376c08),
            u64_to_ff(0x2748774c),
            u64_to_ff(0x34b0bcb5),
            u64_to_ff(0x391c0cb3),
            u64_to_ff(0x4ed8aa4a),
            u64_to_ff(0x5b9cca4f),
            u64_to_ff(0x682e6ff3),
            u64_to_ff(0x748f82ee),
            u64_to_ff(0x78a5636f),
            u64_to_ff(0x84c87814),
            u64_to_ff(0x8cc70208),
            u64_to_ff(0x90befffa),
            u64_to_ff(0xa4506ceb),
            u64_to_ff(0xbef9a3f7),
            u64_to_ff(0xc67178f2),
        ];
        ...
        let (global_range_table, max_of_width) = match use_global_range_table {
            true => {
                ...
                (
                    Some(cs.get_table(global_range_table_name)?),
    ...
    fn converter_helper(
        ...
        let t = map_into_sparse_form(
            rotate_extract(n as usize, rotation, extraction),
            sparse_base as usize,
        );
    ...
    fn extact_32_bits_from_tracked_num<CS: ConstraintSystem<E>>(
        &self,
        cs: &mut CS,
        ...
        let res = if self.use_global_range_table {
            ...
            let cf = [
                E::Fr::one(),
                u64_to_ff(1 << range_table_width),
                u64_to_ff(1 << (2 * range_table_width)),
            ];
            ...
            let low =
                self.allocate_converted_num(cs, &var, SHA256_GADGET_CHUNK_SIZE, 0, 0, 0, 0)?;
            let mid = self.allocate_converted_num(
                cs,
                &var,
                SHA256_GADGET_CHUNK_SIZE,
                SHA256_GADGET_CHUNK_SIZE,
            ...
            let cf = [
                E::Fr::one(),
                u64_to_ff(1 << SHA256_GADGET_CHUNK_SIZE),
                u64_to_ff(1 << (2 * SHA256_GADGET_CHUNK_SIZE)),
                u64_to_ff(1 << SHA256_REG_WIDTH),
            ];

            let mut acc = var.clone();
            let trunc_table = &self.sha256_base4_rot2_width10_table;
            self.query_table_acc(
                cs,
                &self.sha256_base4_rot2_table,
                &low,
                &mut acc,
                &cf[0],
                false,
    ...
    fn convert_into_sparse_chooser_form<CS: ConstraintSystem<E>>(
        ...
        let cf = [
            ...
            u64_to_ff(1 << SHA256_GADGET_CHUNK_SIZE),
            u64_to_ff(1 << (2 * SHA256_GADGET_CHUNK_SIZE)),
            u64_to_ff(1 << (3 * SHA256_GADGET_CHUNK_SIZE)),
        ];
        ...
        let (sparse_low, sparse_low_rot6) = self.query_table_acc(
            cs,
            &self.sha256_base7_rot6_table,
            &low,
            &mut acc,
            &cf[0],
            false,
        )?;
        let (sparse_mid, _sparse_mid_rot6) = self.query_table_acc(
            cs,
            &self.sha256_base7_rot6_table,
            &mid,
            &mut acc,
        ...
        let (sparse_high, sparse_high_rot3) = self.query_table_acc(
            cs,
            &self.sha256_base7_rot3_extr10_table,
            &high,
            &mut acc,
            &cf[2],
            true,
    ...
    fn convert_into_sparse_majority_form<CS: ConstraintSystem<E>>(
        ...
        if let Num::Constant(x) = input.num {
            ...
            let res = SparseMajValue {
                normal: (Num::Constant(x)).into(),
                sparse: Num::Constant(self.converter_helper(
                    n,
                    SHA256_MAJORITY_SHEDULER_BASE,
                    0,
                    0,
                ...
                rot13: Num::Constant(self.converter_helper(
                    n,
                    SHA256_MAJORITY_SHEDULER_BASE,
                    13,
                    0,
                )),
                rot22: Num::Constant(self.converter_helper(
                    n,
                    SHA256_MAJORITY_SHEDULER_BASE,
                    22,
                    0,
        ...
        let (sparse_low, sparse_low_rot2) = self.query_table_acc(
            cs,
            &self.sha256_base4_rot2_table,
            &low,
            &mut acc,
        ...
        let (sparse_mid, sparse_mid_rot2) = self.query_table_acc(
            cs,
            &self.sha256_base4_rot2_table,
            &mid,
            &mut acc,
        ...
        let (sparse_high, _) = self.query_table_acc(
            cs,
            &self.sha256_base4_rot2_width10_table,
            &high,
            &mut acc,
            &cf[2],
            true,
    ...
    fn normalize<CS: ConstraintSystem<E>, F: Fn(E::Fr) -> E::Fr>(
        ...
        for (_is_first, is_last, input_chunk) in input_slices.iter().identify_first_last() {
            let (f_out_chunk, g_out_chunk) =
                self.query_table_acc(cs, table, input_chunk, &mut acc, &coef, is_last)?;
        ...
        let d_next_actually_used = AllocatedNum::long_weighted_sum_eq(
            cs,
            &output_slices,
            &output_base,
            &output,
        ...
        CS: ConstraintSystem<E>,
    {
        ...
        let t0 = Num::lc(
            cs,
            &[E::Fr::one(), two, three],
            &[e.sparse, f.sparse, g.sparse],
        )?;
        let t1 = Num::lc(
            cs,
            &[E::Fr::one(), E::Fr::one(), E::Fr::one()],
            &[e.rot6, e.rot11, e.rot25],
        )?;
        ...
        CS: ConstraintSystem<E>,
    {
        ...
        let (sparse_low, sparse_low_rot7) = self.query_table_acc(
            cs,
            &self.sha256_base4_rot7_table,
            &low,
            &mut acc,
            &cf[0],
            false,
        ...
        let (sparse_mid, sparse_mid_rot7) = self.query_table_acc(
            cs,
            &self.sha256_base4_rot7_table,
            &mid,
            &mut acc,
        ...
        let full_sparse_shift_3 = {
            ...
            let new_val = var.get_value().map(|fr| {
                ...
                let m = map_into_sparse_form(
                    shift_right(n as usize, 3),
                    SHA256_MAJORITY_SHEDULER_BASE as usize,
                );
        ...
        let t =
            Num::Variable(full_sparse_rot7.add_two(cs, full_sparse_rot18, full_sparse_shift_3)?);
        ...
        CS: ConstraintSystem<E>,
    {
        ...
        let cf = [
            E::Fr::one(),
            u64_to_ff(1 << SHA256_GADGET_CHUNK_SIZE - 1),
            u64_to_ff(1 << (2 * SHA256_GADGET_CHUNK_SIZE) - 1),
            u64_to_ff(1 << SHA256_REG_WIDTH),
        ];
        ...
        // there will be three chunks (low, mid, high) for 32bit number
        let low =
            self.allocate_converted_num(cs, &var, SHA256_GADGET_CHUNK_SIZE - 1, 0, 0, 0, 0)?;
        let mid = self.allocate_converted_num(
            cs,
            &var,
            SHA256_GADGET_CHUNK_SIZE,
        ...
        let high = self.allocate_converted_num(
            ...
            &var,
            SHA256_GADGET_CHUNK_SIZE,
            2 * SHA256_GADGET_CHUNK_SIZE - 1,
            0,
            0,
            0,
        )?;

        let (sparse_low, _) = self.query_table_acc(
            cs,
            &self.sha256_base4_rot2_width10_table,
            &low,
            &mut acc,
        ...
        let full_sparse_rot19 = {
            let (_, sparse_mid_rot9) =
                self.query_table(cs, &self.sha256_sheduler_helper_table, &mid)?;
        ...
        let t =
            Num::Variable(full_sparse_rot17.add_two(cs, full_sparse_rot19, full_sparse_shift10)?);
        let (r, d_next_flag) = self.normalize(
            cs,
            &t,
            &self.sha256_maj_sheduler_normalization_table,
    ...
    fn message_expansion<CS: ConstraintSystem<E>>(
        &self,
        cs: &mut CS,
        message: &[Num<E>],
    ) -> Result<Vec<NumWithTracker<E>>> {
        ...
        for j in 16..64 {
            ...
            let mut sum = self.tracked_positioned_sum3_mod32(
                cs,
                res[j - 7].clone(),
                res[j - 16].clone(),
                tmp1.into(),
    ...
    fn sha256_inner_block<CS: ConstraintSystem<E>>(
        ...
        for i in 0..64 {
            ...
            let temp1 = self.tracked_positioned_sum3_with_cnst_mod32(
                cs,
                h.normal,
                ch,
                inputs[i].clone(),
    ...
    pub fn sha256<CS: ConstraintSystem<E>>(
        &self,
        cs: &mut CS,
        message: &[Num<E>],
    ) -> Result<[Num<E>; 8]> {
    ...
    pub fn sha256_round_function<CS: ConstraintSystem<E>>(
        ...
        let state =
            self.sha256_inner_block(cs, state, &expanded_block[..], &self.round_constants)?;
    ...
    pub fn sha256_from_bytes<CS: ConstraintSystem<E>>(
        &self,
        cs: &mut CS,
        bytes: &[Byte<E>],
    ) -> Result<[Num<E>; 8]> {
        ...
        padded.extend(
            repr.iter()
                .map(|num| Byte::from_cnst(u64_to_ff(*num as u64))),
        );
    ...
    pub fn sha256_from_bytes_to_bytes<CS: ConstraintSystem<E>>(
        &self,
        cs: &mut CS,
        bytes: &[Byte<E>],
    ) -> Result<[Byte<E>; 32]> {
