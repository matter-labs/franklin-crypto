...
pub fn inscribe_default_range_table_for_bit_width_over_first_three_columns<
    E: Engine,
...
pub fn inscribe_range_table_for_bit_width_over_first_three_columns<
    E: Engine,
    CS: ConstraintSystem<E>,
>(
    cs: &mut CS,
    ...
    let generator = move || {
        format!(
            "{} {} bits over A/B/C",
            DEFAULT_RANGE_TABLE_NAME_PREFIX, width
        )
    };
    let name = (&generator)();
