...
pub fn make_random_points_with_unknown_discrete_log_from_seed<
    G: GenericCurveProjective + rand::Rand,
>(
    dst: &[u8],
    seed: &[u8],
    num_points: usize,
...
pub fn make_random_points_with_unknown_discrete_log_generic<
    G: GenericCurveProjective + rand::Rand,
>(
    dst: &[u8],
    num_points: usize,
