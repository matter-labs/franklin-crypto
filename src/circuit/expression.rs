...
mod test {
    ...
    use bellman::pairing::ff::{Field, PrimeField, BitIterator};
    use ::circuit::test::*;
    use super::{AllocatedNum, Boolean, Num, AllocatedBit};
    ...
    fn test_lc_equals() {
        ...
        let eq4 = Expression::equals(cs.namespace(||"eq one_const b_true_const"), 
            Expression::boolean::<TestConstraintSystem::<Bls12>>(b_true_const), 
            Expression::constant::<TestConstraintSystem::<Bls12>>(Fr::one())).unwrap();
